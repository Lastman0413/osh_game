    ...
    for wall in room.walls:
        ...
        if wall["type"] == "horizontal":
            ...
            top_pts = [
                (start_iso_x + cam_off[0], start_iso_y + cam_off[1]),
                (end_iso_x + cam_off[0], end_iso_y + cam_off[1]),
                (end_iso_x + cam_off[0], end_iso_y - top_depth + cam_off[1]),
                (start_iso_x + cam_off[0], start_iso_y - top_depth + cam_off[1])
            ]
            pygame.draw.polygon(surface, (160, 150, 130), top_pts)  # 약간 밝게
            ...
            top_pts = [
                (start_iso_x + cam_off[0], start_iso_y + cam_off[1]),
                (end_iso_x + cam_off[0], end_iso_y + cam_off[1]),
                (end_iso_x - top_depth + cam_off[0], end_iso_y + cam_off[1]),
                (start_iso_x - top_depth + cam_off[0], start_iso_y + cam_off[1])
            ]
