...
def draw_room(surface, room, cam_off, cur_w, cur_h):
    ...
    for wall in room.walls:
        ...
        if wall["type"] == "horizontal":
            ...
            wall_height = 30
            wall_pts = [
                (start_x + cam_off[0], start_y + cam_off[1]),
                (end_x + cam_off[0], end_y + cam_off[1]),
                (end_x + cam_off[0], end_y + wall_height + cam_off[1]),
                (start_x + cam_off[0], start_y + wall_height + cam_off[1])
            ]
            pygame.draw.polygon(surface, COLOR_WALL, wall_pts)
            pygame.draw.polygon(surface, (150, 140, 120), wall_pts, 2)
